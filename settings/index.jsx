   ...
   <Page>
      ...
      <Section title={<Text bold align="center">Layout</Text>}>
          ...
          <Section>
              ...
              <Select label={`Layout Three`} settingsKey="layoutThree" options={[ {name:"steps (default)", value:"steps"},  {name:"floors", value:"floors"}, {name:"predicted bg", value:"predictedbg"}, {name:"current bg", value:"currentbg"}, {name:"temp basal", value:"tempbasal"}, {name:"raw bg", value:"rawbg"}, {name:"loop status", value:"loopstatus"}, {name:"uploader battery", value:"upbat"}, {name:"Sensor age", value:"sage"} ]} />
              <Select label={`Layout Four`} settingsKey="layoutFour" options={[ {name:"heart (default)", value:"heart"}, {name:"floors", value:"floors"}, {name:"predicted bg", value:"predictedbg"}, {name:"current bg", value:"currentbg"}, {name:"temp basal", value:"tempbasal"}, {name:"raw bg", value:"rawbg"}, {name:"loop status", value:"loopstatus"}, {name:"uploader battery", value:"upbat"}, {name:"Sensor age", value:"sage"} ]} />
      </Section> : null) : null)}      
    </Section>
